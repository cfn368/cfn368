...
- [Nuclear power in Denmark's energy mix](link) — EnergyPLAN + GrønREFORM analysis  
- [VE variation and electricity prices](link) — some fun data on RE properties in DK
- [Human Capitalists in The Intangible Era](link) — two-sector GE model coded in Python (bsc thesis)
